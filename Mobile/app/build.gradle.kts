...
android {
    ...
    sonarqube {
        properties {
            property("sonar.projectKey", "mobile")
            property("sonar.projectName", "mobile")
            property("sonar.login", "sqp_8a9cded381f2f9d2bc7cd4eab36643c24f7156cc")
            property("sonar.host.url", "http://master:9000")
        }
    }
}
